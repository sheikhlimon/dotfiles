...
- Your primary method for interacting with GitHub should be the aliases i have in .zshrc-personal

## Git

- When creating branches, prefix them with feat/ fix/ chore/ whatever appropriate.
